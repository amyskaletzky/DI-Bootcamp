-- Database: daily challenge day 3 week 6
-- Part I
...
CREATE TABLE customer_profile (
	...
	customer_id INTEGER UNIQUE REFERENCES customer (id) -- ON DELETE CASCADE ON UPDATE CASCADE (ALTER)
)
...
CREATE TABLE student (
	...
	age INTEGER CHECK(age <= 15) NOT NULL  -- CAN USE SMALLINT
)
...
-- Redoing because Patrick is unrelated to the junction table 
DELETE FROM student
WHERE name = 'John'

SELECT * FROM library
-- what happened to junction table: The record of John's borrowed book is also deleted
